...
function About() {
  return (
    <div className="container mx-auto px-4 mb-20">
      <h1 className="uppercase text-red-500 mb-2">Our Menu</h1>
      <p className="uppercase text-2xl lg:text-4xl text-zinc-800 mb-20 lg:mb-36 lg:w-8/12">
        What happens when you bring together the passion for cleanliness and an
        urge for traditional goodness together?
      </p>
